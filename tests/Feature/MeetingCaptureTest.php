...
test('meeting capture applies a full set of extracted parliamentary relationships', function () {
    ...
    $component = Livewire::actingAs(User::factory()->create())
        ...
        ->assertSee('wire:key="suggested-organization-'.sha1($organizations[0]).'"', false)
        ->assertSee("wire:click=\"acceptSuggestedOrganizationByKey('".sha1($organizations[0])."')\"", false)
        ->assertSee("wire:click=\"rejectSuggestedOrganizationByKey('".sha1($organizations[0])."')\"", false)
        ->assertDontSee('acceptSuggestedOrganization(&quot;', false)
        ->call('acceptSuggestedOrganizationByKey', sha1('National Assembly of Zambia'))
        ->call('acceptSuggestedOrganizationByKey', sha1('Committee Department'))
        ->call('rejectSuggestedOrganizationByKey', sha1('Commonwealth'))
        ->call('acceptAllSuggestedOrganizations')
        ->call('acceptSuggestedPersonByKey', sha1('Kelezo Lusaka'))
        ->call('acceptSuggestedPersonByKey', sha1('Clive Lelembo'))
        ->call('rejectSuggestedPersonByKey', sha1('Elvis Chipuka'))
        ->call('acceptAllSuggestedPeople')
        ->call('acceptSuggestedIssueByKey', sha1($issues[0]))
        ->call('acceptSuggestedIssueByKey', sha1($issues[1]))
