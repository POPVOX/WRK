<div
    class="flex items-center justify-between px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors group">
    ...
    <div class="flex items-center gap-2 flex-shrink-0">
        {{-- Add Notes button --}}
        <a href="{{ route('meetings.show', $meeting) }}#notes" wire:navigate
            class="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-amber-700 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/30 rounded-lg hover:bg-amber-100 dark:hover:bg-amber-900/50 transition">
