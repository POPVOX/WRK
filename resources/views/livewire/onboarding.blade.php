    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @if($step === 1)
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 animate-fade-in">
                <div class="text-center mb-8">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Welcome to WRKBench! 👋</h2>
                ...
                @if($isCalendarConnected)
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="font-medium text-green-800 dark:text-green-300">Google Workspace Connected!</p>
                                <p class="text-sm text-green-600 dark:text-green-400">Calendar and Gmail access are ready.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        @if($step === 4)
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 animate-fade-in text-center">
                ...
                @else
                    <p class="text-gray-500 dark:text-gray-400 mb-6">Your profile is ready. Welcome to WRKBench!</p>
                @endif
